            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item"><a class="nav-link{{ Route::currentRouteName() == 'blog' ? ' active' : '' }}" href="/blog">Data User</a></li>
                        <li class="nav-item"><a class="nav-link{{ Route::currentRouteName() == 'event' ? ' active' : '' }}" href="/event">Pengumuman</a></li>
                        @endrole
                        @role('user')
                        <li class="nav-item"><a class="nav-link{{ Route::currentRouteName() == 'blog' ? ' active' : '' }}" href="/blog">Data User</a></li>
                        <li class="nav-item"><a class="nav-link{{ Route::currentRouteName() == 'event' ? ' active' : '' }}" href="/event">Pengumuman</a></li>
